...
db.category.hasMany(db.product, { as: 'product', onDelete: 'CASCADE' });
...
db.product.hasMany(db.feature, { as: 'feature', onDelete: 'CASCADE' });
...
db.feature.hasMany(db.property, { as: 'property', onDelete: 'CASCADE' });
